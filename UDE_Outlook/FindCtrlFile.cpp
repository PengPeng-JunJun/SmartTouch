...
BOOL CFindCtrlFile::SearchControllerFile()
{
	...
	strFolderPath = GetExePath() + _T("\\Controller");
...
{
	CString strFolderPath;
	strFolderPath = GetExePath() + _T("\\Report");
...
{
	CString strFolderPath;
	strFolderPath = GetExePath() + _T("\\Template");
...
{
	CString strFolderPath;
	strFolderPath = GetExePath() + strPath;
...
{
	CString strFilePath;
	strFilePath = GetExePath() + _T("\\Controller\\") + strFileName + _T(".ini");
